    ...
    <div className="space-y-5">
      <header className="ui-surface rounded-2xl border-l-4 border-l-[var(--accent)] p-5">
        ...
        <p className="mt-1 max-w-2xl text-sm leading-relaxed text-[color:var(--foreground)]/55">
          Ici : votre <strong className="font-semibold text-[color:var(--foreground)]/75">agenda du jour</strong>{" "}
          (créneaux horaires générés automatiquement). Pour la liste complète de vos tâches par échéance, utilisez{" "}
          <strong className="font-semibold text-[color:var(--foreground)]/75">Mes tâches</strong> dans le tableau de
          bord.
        </p>
        <Link
          href="/dashboard/todo"
