        ...
        <header className="border-b border-[var(--line)] pb-8 pt-2">
          <div className="flex flex-wrap items-end justify-between gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                {branding.tagline ? (
                  <p className="ui-kicker mb-2">{branding.tagline}</p>
                ) : null}
                <h1 className="ui-display text-4xl text-[var(--foreground)] sm:text-5xl">{branding.appName}</h1>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <h3 className="flex items-center gap-2 text-lg font-semibold">
                ...
                Outil interne {branding.appName}
              </h3>
              <p className="mt-1 text-sm text-[color:var(--foreground)]/60">
                Environnement sécurisé pour votre équipe, avec notifications en temps réel et workflows unifiés.
              </p>
            </div>
            <Link
              href="/login"
