...
export const en: MessageTree = {
  ...
  nav: {
    ...
    billing: {
      ...
      trialBody: "From €{floor}/mo for the whole team. Then €{seat} per user. No hidden tiers.",
      expiredKicker: "Trial ended",
      expiredTitle: "Pick up where you left off",
      expiredBody: "Reactivate in one click: €{floor}/mo min, everything included.",
      ...
      activeBody: "{count} seats · all included from €{floor}/mo",
    },
  },
  modules: {
