...
export const fr: MessageTree = {
  ...
  settings: {
    ...
    billingSubtitle:
      "Un seul plan : 2 €/utilisateur/mois (min. 10 € jusqu'à 5 personnes). Essai 14 jours sans carte.",
  ...
  nav: {
    ...
    billing: {
      ...
      trialBody: "Dès {floor} €/mois pour toute l'équipe. Puis {seat} € / utilisateur. Sans engagement caché.",
      expiredKicker: "Essai terminé",
      expiredTitle: "Reprenez là où vous étiez",
      expiredBody: "Réactivez en 1 clic : {floor} €/mois min., tout inclus.",
      ...
      activeBody: "{count} collab. · tout inclus dès {floor} €/mois",
    },
  },
  modules: {
