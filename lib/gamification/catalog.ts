...
export const BADGES: BadgeDefinition[] = [
  ...
  {
    id: "board_pilot",
    titleKey: "gamification.badges.boardPilot.title",
    descriptionKey: "gamification.badges.boardPilot.description",
    icon: "layers",
  },
  {
    id: "module_explorer",
    titleKey: "gamification.badges.moduleExplorer.title",
    descriptionKey: "gamification.badges.moduleExplorer.description",
    icon: "compass",
  },
  {
    id: "centurion",
...
export const TUTORIALS: TutorialDefinition[] = [
  ...
  {
    id: "board_exploration",
    titleKey: "gamification.tutorials.boardExploration.title",
    descriptionKey: "gamification.tutorials.boardExploration.description",
    badgeId: "board_pilot",
    xpReward: 75,
    href: "/dashboard/kanban",
    tourParam: "boardTour=1",
    estimatedMinutes: 4,
  },
  {
    id: "module_discovery",
    titleKey: "gamification.tutorials.moduleDiscovery.title",
    descriptionKey: "gamification.tutorials.moduleDiscovery.description",
    badgeId: "module_explorer",
    xpReward: 50,
    href: "/dashboard/kanban",
    estimatedMinutes: 6,
  },
