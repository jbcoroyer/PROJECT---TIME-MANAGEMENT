...
|-------|-------|
| `/` | Landing marketing |
| `/pricing` | Tarifs (Gratuit, Starter, Pro) |
...
| Plan | Limites principales |
|------|---------------------|
| **Essai** | 14 jours, tous les modules |
| **Gratuit** | 2 utilisateurs max, **5 modules** au choix |
| **Starter** | 19 €/mois, tous les modules |
| **Pro** | 49 €/mois, IA + Outlook + Slack, jusqu’à 25 utilisateurs |
